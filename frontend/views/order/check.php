...
<section id="checkout-page">
    <div class="container">
        <div class="col-xs-12 no-margin">
            <section id="shipping-address" style="margin-bottom:100px;margin-top:-10px">
                ...
                <?php foreach($addresses as $key => $address): ?>
                    <div class="row field-row" style="margin-top:10px">
                        ...
                        <a style="margin-left:10px" href="#" class="editAddress">编辑</a>
                        <input type="hidden" name="firstname1" value="<?php  echo $address['firstname']?>" />
                        <input type="hidden" name="lastname1" value="<?php  echo $address['lastname']?>" />
                        <input type="hidden" name="company1" value="<?php  echo $address['company']?>" />
                        <input type="hidden" name="address11" value="<?php  echo $address['address']?>" />
                        <input type="hidden" name="postcode1" value="<?php  echo $address['postcode']?>" />
                        <input type="hidden" name="email1" value="<?php  echo $address['email']?>" />
                        <input type="hidden" name="telephone1" value="<?php  echo $address['telephone']?>" />
                        <input type="hidden" name="addressid1" value="<?php  echo $address['addressid']?>" />
                    </div><!-- /.field-row -->
                <?php endforeach; ?>
            ...
            <!--编辑联系人-->
            <div class="billing-address1" style="display:none;" id="updateAddress">
                <h2 class="border h1">编辑联系人</h2>
                <?php ActiveForm::begin([
                ...
                <div class="row field-row">
                    <div class="col-xs-12 col-sm-6">
                        <label>姓*</label>
                        <input class="le-input" name="addid"  type="hidden" id="addid">
                        <input class="le-input" name="firstname"  id="firstname">
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <label>名*</label>
                        <input class="le-input" name="lastname" id="lastname" >
                    </div>
                </div><!-- /.field-row -->
                ...
                <div class="row field-row">
                    <div class="col-xs-12">
                        <label>公司名称</label>
                        <input class="le-input" name="company" id="company" >
                    </div>
                </div><!-- /.field-row -->
                ...
                <div class="row field-row">
                    <div class="col-xs-12 col-sm-6">
                        <label>地址*</label>
                        <input class="le-input" data-placeholder="例如：北京市朝阳区" name="address1"  id="address1">
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <label>&nbsp;</label>
                        <input class="le-input" data-placeholder="例如：酒仙桥北路" name="address2" id="address2" >
                    </div>
                </div><!-- /.field-row -->
                ...
                <div class="row field-row">
                    <div class="col-xs-12 col-sm-4">
                        <label>邮编</label>
                        <input class="le-input" name="postcode"  id="postcode">
                    </div>
                    <div class="col-xs-12 col-sm-4">
                        <label>电子邮箱地址*</label>
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <label>联系电话*</label>
                        <input class="le-input" name="telephone" id="telephone" >
                    </div>
                </div><!-- /.field-row -->
