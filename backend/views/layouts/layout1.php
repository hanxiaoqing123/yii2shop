...
<head>
    ...
    <!-- libraries -->
    <link href="shopassets/admin/css/lib/jquery-ui-1.10.2.custom.css" rel="stylesheet" type="text/css" />
    <link href="shopassets/admin/css/lib/font-awesome.css" type="text/css" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="shopassets/admin/css/compiled/index.css" type="text/css" media="screen" />
    <link href="shopassets/admin/css/lib/bootstrap-wysihtml5.css" type="text/css" rel="stylesheet" />
    <link rel="stylesheet" href="shopassets/admin/css/compiled/form-showcase.css" type="text/css" media="screen" />
    <!-- open sans font -->
            ...
            <li class="notification-dropdown hidden-phone">
                ...
                <div class="pop-dialog">
                    ...
                    <div class="body">
                        ...
                        <div class="messages">
                            <a href="#" class="item">
                                <img src="shopassets/admin/img/contact-img.png" class="display" />
                            ...
                            <a href="#" class="item">
                                <img src="shopassets/admin/img/contact-img2.png" class="display" />
                                <div class="name">Alejandra Galván</div>
                                <div class="msg">
...
<script src="shopassets/admin/js/jquery-ui-1.10.2.custom.min.js"></script>
<!-- knob -->
<script src="shopassets/admin/js/jquery.knob.js"></script>
<!-- flot charts -->
<script src="shopassets/admin/js/jquery.flot.js"></script>
<script src="shopassets/admin/js/jquery.flot.stack.js"></script>
<script src="shopassets/admin/js/jquery.flot.resize.js"></script>
<script src="shopassets/admin/js/theme.js"></script>
<script src="shopassets/admin/js/wysihtml5-0.3.0.js"></script>
<script src="shopassets/admin/js/bootstrap-wysihtml5-0.0.2.js"></script>
