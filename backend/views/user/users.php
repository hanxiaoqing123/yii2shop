    <link rel="stylesheet" href="shopassets/admin/css/compiled/user-list.css" type="text/css" media="screen" />
    <!-- main container -->
    <div class="content">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            <td>
                                ...
                                <?php else: ?>
                                    <img src="shopassets/uploads/avatar/<?php echo $user->profile->avatar; ?>" class="img-circle avatar hidden-phone" />
                                <?php endif; ?>
