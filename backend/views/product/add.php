...
<link rel="stylesheet" href="shopassets/admin/css/compiled/new-user.css" type="text/css" media="screen" />
<!-- main container -->
<div class="content">
                ...
                <div class="span9 with-sidebar">
                    <div class="container">
                        ...
                        if (Yii::$app->session->hasFlash('info')) {
                            echo "<h5 style='color: red'>".Yii::$app->session->getFlash('info')."<h5>";
                        }
